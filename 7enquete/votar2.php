...
mysqli_query($conexao,"INSERT INTO enquete (idenquete) VALUES (2)");

if(isset($_POST["opc"]) && ($opc=="otimo"))
{
$sql="UPDATE enquete set otimo=$otimo where idenquete=2";
}
if(isset($_POST["opc"]) && ($opc=="bom"))
{
$sql="UPDATE enquete set bom=$bom,idenquete=2 where idenquete=2";
}
if(isset($_POST["opc"]) && ($opc=="mais_ou_menos"))
{
$sql="UPDATE enquete set mais_ou_menos=$mais_ou_menos where idenquete=2";
}
if(isset($_POST["opc"]) && ($opc=="ruim"))
{
$sql="UPDATE enquete set ruim=$ruim where idenquete=2";
}
$resultado=mysqli_query($conexao,$sql);
