...
$sql="SELECT * FROM enquete where idenquete=2";
...
<form action="votar2.php" method="post">
    <table width="310" border="1">
      <tr bgcolor="#FFFFFF"> 
        <td colspan="4" align="center" bordercolor="#000000"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Resultado 
          Enquete</strong></font></td>
      </tr>
      <tr bgcolor="#FFFFFF"> 
        <td colspan="4" align="center" bordercolor="#000000"><em><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>O 
